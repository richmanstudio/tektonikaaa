...
const timeline = [
  { year: "2023", title: "Основание компании", desc: "Регистрация ООО «Тектроника» в Хабаровске." },
  { year: "2024", title: "Первый успешный проект", desc: "Завершили полевые геофизические исследования для крупного заказчика." },
  { year: "2025", title: "Открытие своего сайта", desc: "Открыли свой корпоративный сайт для быстрого доступа ко всему необходимому и устройству к нам" },
];
