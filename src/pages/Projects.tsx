...
const PROJECTS = [
  {
    ...
    title: "Проект «Солнечный»",
    region: "Хабаровский край",
    year: 2023,
    short: "Сейсморазведка для планирования солнечной электростанции.",
    desc: "Выполнен полный комплекс работ: сейсморазведка 2D, магнитная съёмка БПЛА, построение скоростной модели, рекомендации по свайным полям.",
  },
  {
    id: "tiger",
    image: "/src/assets/projects/tiger.jpg",
    title: "Проект «Тигровый»",
    region: "Приморский край",
    year: 2022,
    short: "Комплексная съёмка площадок биосферного заповедника.",
    desc: "Минимизировали антропогенное воздействие, использовали беспилотники и малошумные виброисточники. Результаты помогли скорректировать трассы прокладки ЛЭП.",
  },
  {
    id: "orlina",
    image: "/src/assets/projects/orlina.jpg",
    title: "Проект «Орлинка»",
    region: "Еврейская АО",
    year: 2021,
    short: "Гравиметрия и электроразведка в горно-лесном рельефе.",
    desc: "Обнаружены аномальные зоны, подтверждённые бурением. Построена 3‑D модель руды и оценён запасы по JORC.",
  },
] as const;

const YEARS = ["Все", 2023, 2022, 2021] as const;
